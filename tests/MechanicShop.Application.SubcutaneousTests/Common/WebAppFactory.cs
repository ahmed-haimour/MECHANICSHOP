...
// “Start the application using the assembly that contains IAssemblyMarker.”
public class WebAppFactory : WebApplicationFactory<IAssemblyMarker>, IAsyncLifetime
{
    ...
    public Task InitializeAsync() // this run BEFORE any tests use this fixture
    {
        return _dbContainer.StartAsync()
            .ContinueWith(async _ => //  After SQL starts run this code ↓
            {
    ...
    // this run AFTER all tests finish
