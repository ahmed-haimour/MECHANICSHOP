...
using MechanicShop.Domain.Common.WorkOrders;
...
public class WorkOrderTests
{
    ...
    public void Create_ShouldReturnError_WhenIdIsEmpty()
    {
        ...
        Assert.False(wo.IsSuccess); // Verify that wo.IsSuccess is false.
    ...
    {
        var repairTaskResult = RepairTaskFactory.CreateRepairTask();
        ...
        var wo = woResult.Value;

        var result = wo.AddRepairTask(repairTask);
